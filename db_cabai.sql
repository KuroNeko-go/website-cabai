...
INSERT INTO `bibits` (`id`, `cabai_id`, `nama_produk`, `harga`, `harga_diskon`, `stok`, `berat`, `deskripsi`, `gambar`, `is_popular`, `is_new`, `created_at`, `updated_at`) VALUES
	...
	(2, 2, 'Bibit Shypoon Anti Virus', 32000, NULL, 19, 10, 'Bibit dengan ketahanan tinggi terhadap Virus Gemini. Tanaman akan tumbuh sehat meskipun di lahan yang rawan penyakit.', NULL, 1, 0, '2026-05-07 16:09:33', '2026-05-07 16:09:33'),
...
INSERT INTO `cabais` (`id`, `nama_varietas`, `nama_latin`, `tingkat_pedas`, `skala_pedas`, `umur_panen`, `cocok_ditanam`, `keunggulan`, `deskripsi`, `gambar`, `created_at`, `updated_at`, `harga`) VALUES
	...
	(9, 'tes', 'tes', 'Extra Pedas', 5, 60, 'Dataran rendah', 'tes', 'tes', 'uploads/cabai/307db8bdec8a477bfd834efe2dd915b6.jpg', '2026-06-24 19:17:18', '2026-06-24 19:17:18', 0);
...
-- Dumping data for table db_cabai_lengkap.keranjang: ~0 rows (approximately)
...
-- Dumping data for table db_cabai_lengkap.transaksi: ~27 rows (approximately)
...
-- Dumping data for table db_cabai_lengkap.transaksi_detail: ~34 rows (approximately)
...
-- Dumping data for table db_cabai_lengkap.users: ~18 rows (approximately)
INSERT INTO `users` (`id`, `username`, `nama_lengkap`, `password`, `email`, `foto`, `role`, `last_login`, `is_active`, `created_at`) VALUES
	...
	(15, 'fvck', 'fvck', '$2y$10$v7f01FRdCXC0u4mZfCfkQuPcWrJ19AhM1ygPbO.wmkGURt8M/dDA6', 'fvck@gmail.com', NULL, 'user', '2026-06-24 01:25:36', 1, '2026-06-23 18:08:50'),
	...
	(18, 'giovanna', 'giorno', '$2y$10$7FRH1xMttSAUlXLggz3hMuenNB2l6PgoGTODMfNGoYExpTIPbJClW', 'giogio@gmail.com', NULL, 'user', '2026-06-25 18:06:42', 1, '2026-06-24 16:53:12'),
	(19, 'aseng', 'antek', '$2y$10$.7x199ikKq9.IP1WLvk3WO6hLac5dBLI9txOTmdjBWCpEUE6NU4yO', 'aseng@gmail.com', NULL, 'admin', '2026-06-25 18:06:26', 1, '2026-06-25 17:59:38');
